USE [MvcMusicStore]
GO
ALTER TABLE [MvcMusicStore].[dbo].[Album] DROP CONSTRAINT [FK__Album__ArtistId__276EDEB3]
GO
ALTER TABLE [MvcMusicStore].[dbo].[Album] DROP CONSTRAINT [FK_Album_Genre]
GO
ALTER TABLE [MvcMusicStore].[dbo].[Cart] DROP CONSTRAINT [FK_Cart_Album]
GO
ALTER TABLE [MvcMusicStore].[dbo].[OrderDetail] DROP CONSTRAINT [FK__InvoiceLi__Invoi__2F10007B]
GO
ALTER TABLE [MvcMusicStore].[dbo].[OrderDetail] DROP CONSTRAINT [FK_InvoiceLine_Album]
GO
DROP TABLE [MvcMusicStore].[dbo].[Cart]
GO
DROP TABLE [MvcMusicStore].[dbo].[OrderDetail]
GO
ALTER TABLE [MvcMusicStore].[dbo].[Album] DROP CONSTRAINT [DF_Album_AlbumArtUrl]
GO
DROP TABLE [MvcMusicStore].[dbo].[Album]
GO
DROP TABLE [MvcMusicStore].[dbo].[Artist]
GO
DROP TABLE [MvcMusicStore].[dbo].[Genre]
GO
DROP TABLE [MvcMusicStore].[dbo].[Order]
GO
SET ANSI_NULLS ON
GO
